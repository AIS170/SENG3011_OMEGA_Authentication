from src.auth import sign_up, confirm_signup, admin_confirm_signup, login, logout, delete_user, generate_secret_hash
...
def test_admin_confirm_signup_not_allowed(mock_cognito, mock_dynamo, monkeypatch):
