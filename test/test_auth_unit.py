...
def test_signup(test_cognito, clear_dynamo):
    ret = sign_up("jd101", "john.doe@gmail.com", "goodPassword123!", "John Doe")
...
def test_username_in_use(test_cognito, clear_dynamo):
    ...
    ret = sign_up("jd101", "jane.doe@gmail.com", "goodPassword123!", "Jane Doe")
...
def test_bad_password(test_cognito, clear_dynamo):
    ret = sign_up("jd101", "john.doe@gmail.com", "badpassword", "John Doe")
...
def test_admin_confirm_signup_not_allowed(clear_dynamo, test_cognito, monkeypatch):
...
def test_admin_confirm_signup_user_not_found(test_cognito, clear_dynamo):
    ret = admin_confirm_signup("jd101")
...
def test_forgot_password(test_cognito, clear_dynamo, monkeypatch):
    ...
    monkeypatch.setattr(
        test_cognito["client"], "confirm_forgot_password", test_confirm_forgot_password
    )
...
def test_forgot_password_with_invalid_user(test_cognito, clear_dynamo):
...
def test_confirm_forgot_password_with_invalid_user(
    test_cognito, clear_dynamo, monkeypatch
):
    sign_up("jd101", "john.doe@gmail.com", "goodPassword123!", "John Doe")
    admin_confirm_signup("jd101")
...
def test_resend_confirmation_code(test_cognito, clear_dynamo, monkeypatch):
    ...
    assert ret["message"] == ("A new confirmation code has been sent to your email")
...
def test_update_password(test_cognito, clear_dynamo):
    ...
    ret = update_password(access_token, "goodPassword123!", "greatPassword123!")
...
def test_update_password_invalid_old_password(test_cognito, clear_dynamo):
    ...
    ret = update_password(access_token, "goodPassword1234!", "greatPassword123!")
