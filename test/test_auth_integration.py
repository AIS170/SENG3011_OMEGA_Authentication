...
# confirmation
def test_verify_confirm_signup(client, test_cognito, user_data_1, clear_dynamo):
    client.post(
        "/signup", data=json.dumps(user_data_1), content_type="application/json"
    )
...
def test_signup_no_corruption(client, test_cognito, user_data_1, clear_dynamo):
    ...
    ret = client.post("/signup", data=json.dumps(data), content_type="application/json")
...
# signup
def test_confirm_signup_no_corruption(client, test_cognito, user_data_1, clear_dynamo):
    ret = client.post(
        "/signup", data=json.dumps(user_data_1), content_type="application/json"
    )
    assert ret.status_code == 200
